...
namespace ConcreteGoodsPlantView
{
    public partial class FormProductConcrete : Form
    {
        ...
        private int? id;
        private List<ProductConcreteComponentViewModel> productComponents;
        ...
        }        private void FormProduct_Load(object sender, EventArgs e)
        {
            ...
            {
                productComponents = new List<ProductConcreteComponentViewModel>();
            }
        }
        ...
        private void ButtonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                List<ProductConcreteComponentBindingModel> productComponentBM = new
               List<ProductConcreteComponentBindingModel>();
                for (int i = 0; i < productComponents.Count; ++i)
                {
                    productComponentBM.Add(new ProductConcreteComponentBindingModel
                    {
