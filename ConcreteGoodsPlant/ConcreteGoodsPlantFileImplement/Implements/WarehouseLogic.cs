...
namespace ConcreteGoodsPlantFileImplement.Implements
{
    public class WarehouseLogic : IWarehouseLogic
    {
        ...
        {
            var item = source.WarehouseComponents.FirstOrDefault(x => x.ComponentId == model.ComponentId &&
            ...
            {
                int maxId = source.WarehouseComponents.Count > 0 ? source.WarehouseComponents.Max(rec => rec.Id) : 0;
